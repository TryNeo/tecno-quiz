...
(function($){
    var defaults = {
        ...
        texts: {
            ...
            unselectAll    : 'Quitar Seleccion',   // unselect all text
    ...
    MultiSelect.prototype = {
        ...
        load: function() {
            ...
            $(instance.element).after('<div id="ms-list-'+ instance.listNumber +'" class="ms-options-wrap"><button type="button" class="form-control"><span style="font-size:15px;font-family:sans-serif;">None Selected</span></button><div class="ms-options"><ul></ul></div></div>');
